      ...
      <section className="container prose mb-10 max-w-4xl">
        <div className="flex flex-col space-y-3 md:space-x-3 md:space-y-0">
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 max-w-2xl">
              ...
              <ul className="list-disc space-y-3 pl-5">
                ...
                <li>
                  <Link href="https://github.com/numb-wallet/solana-course" target="_blank">
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 max-w-2xl">
              For security, we follow Solana's recommended practices and have strong DDOS protection
              from our datacenter. We also have a quick-alert monitoring system for any issues with
              server performance.
            </div>
          </div>
        </div>
